...
class rstruct():
    def __init__(self,objects):
        self.__setmems(objects,self)
    def __setmems(self,mems,on):
        for i in mems.keys():
            setattr(on,i,mems[i])
    def __call__(self,name:str,ecls=['object']):
        self._newclass = _Class(name,[f'{ecls}'],functions={'__init__':{'name':'__init__','args':('self',),'lines':['...']}})
